(() => {
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/snackbar/index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/actions-panel/index.ts
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/app/index.ts
  var App = class {
    constructor() {
  ...
  // ns-params:@params
  var giscus = { category: "Giscus", categoryid: "DIC_kwDOK_yGtM4CcLrU", reactions: true, repo: "liluzibird/liluzibird.github.io", repoid: "R_kgDOK_yGtA" };
  var params_default = { analytics: null, archive: { paginate: 20 }, baseURL: "http://localhost:1313/", brand: "Blog Dude", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: false }, color: "auto", contact: null, counttaxonomyposts: true, creativecommons: { by: true, nc: false, nd: false, sa: true }, customcss: null, customjs: null, dateformat: ":date_long", description: "A website where I talk about whatever comes into my mind", diagram: false, featuredpostcount: 5, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Hugo, Bootstrap, Blog Dude, liluzibird, Blog, Documentation, Linux Documentation, Linux Gaming", mainsections: ["blog", "posts", "news", "docs"], palette: "indigo", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "Blog Dude" } }, readingtime: true, recentpostcount: 5, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/liluzibird/liluzibird.github.io" }, reward: null, rss: "home", search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: { enablegitinfo: true }, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { baidu: null, baiduunion: null, bing: null, google: null, shenma: null, so: null, sogou: null }, social: { email: "alberth03@protonmail.com", github: "liluzibird/liluzibird.github.io", linkedin: "albert-huynh-50658b176" }, socialshare: false, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, topappbar: { social: { github: "liluzibird/liluzibird.github.io" } }, viewer: true };

  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/code/code-block.ts
  var CodeBlock = class {
    constructor(element) {
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/code/index.ts
  var Code = class {
    run() {
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/docs/catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/docs/index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/local-storage/index.ts
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/font-size-selector/index.ts
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/form-validator/index.ts
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/iframe/index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/loading-bar/index.ts
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/scroller/index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/sidebar-toggle/index.ts
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/table-wrapper/index.ts
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/toc/index.ts
  var TOC = class {
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/main/js/components.ts
  var components = [];
  var components_default = components;

  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/slide/index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/search/index.ts
  (() => {
    "use strict";
    var _a, _b;
  ...
  // ns-hugo:/home/BigDuck/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.3.1/assets/js/mode/index.ts
  var MODE_AUTO = "auto";
  var MODE_DARK = "dark";
